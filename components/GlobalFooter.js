    ...
    <footer>
      <ul className="allFooterButtons">
          ...
          <Link href='/community'>
            <div className='footerBarOption'>
              <p className='footerIcon'>
                <img className='footerSvg' src={community} alt='community link' />
              </p>
        ...
        <li className={router.pathname == "/companies" ? "activeFooter" : ""}>
          <Link href='/companies'>
            <div className='footerBarOption'>
              <p className='footerIcon'><img className='footerSvg' src={companies} alt='companies link' /></p>
        ...
        <li className={router.pathname == "/journal" ? "activeFooter" : ""}>
          <Link href='/journal'>
            <div className='footerBarOption'>
              <p className='footerIcon'><img className='footerSvg' src={addentry} alt='addentry link' /></p>
        ...
        <li className={router.pathname == "/inspiration" ? "activeFooter" : ""}>
          <Link href='/inspiration'>
            <div className='footerBarOption'>
              <p className='footerIcon'><img className='footerSvg' src={inspiration} alt='inspiration link' /></p>

...
export const results = {
  ...
  collaborating: {
    ...
    notes: 'Owls use a collaborating or problem confronting conflict management style valuing their goals and relationships. \nOwls view conflicts as problems to be solved finding solutions agreeable to all sides (win-win)',
